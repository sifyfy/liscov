...
mod plugin_system_tests {
    ...
    fn test_plugin_event_types() {
        ...
        let events = vec![
            ...
            PluginEvent::MessagesReceived(vec![create_test_message("test1"), create_test_message("test2")]),
...
mod notification_plugin_tests {
    ...
    fn test_notification_types() {
        let notifications = vec![
            ...
            NotificationType::KeywordDetected { keyword: "test".to_string() },
            NotificationType::NewMember { username: "newuser".to_string() },
            NotificationType::VipUser { username: "vipuser".to_string() },
            NotificationType::MessageThreshold { count: 1000 },
            NotificationType::System { message: "System message".to_string() },
        ];
        ...
        for notification in &notifications {
            ...
            match (notification, &deserialized) {
                ...
                (NotificationType::KeywordDetected { .. }, NotificationType::KeywordDetected { .. }) => (),
                (NotificationType::NewMember { .. }, NotificationType::NewMember { .. }) => (),
                (NotificationType::VipUser { .. }, NotificationType::VipUser { .. }) => (),
                (NotificationType::MessageThreshold { .. }, NotificationType::MessageThreshold { .. }) => (),
